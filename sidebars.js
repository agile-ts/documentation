module.exports = {
  docs: [
    ...
    {
      type: 'category',
      label: 'Customize your training',
      collapsed: false,
      items: [
        'customize_training/add_your_parallel',
        'customize_training/amp',
        'customize_training/config',
        'customize_training/model',
        'customize_training/parallelization',
        'customize_training/trainer_engine',
        'customize_training/zero'
      ],
    },
    // {
    //   type: 'category',
